...
# decision_variables_list=[x for x in decision_variables]
# objective_function_list = [0.0865,0.0952,.10,0.0875,0.0925,0.09]

# basic_model.setObjective(\
#     gp.quicksum([weight*dv for weight,dv in zip(objective_function_list,decision_variables_list)]),GRB.MAXIMIZE)

# basic_model.setObjective([weight*dv for weight,dv in zip(objective_function_list,decision_variables_list)],GRB.MAXIMIZE)
