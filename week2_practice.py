...
basic_model.setObjective(80 + 60,GRB.MINIMIZE)

# fourth step Add constraints 
basic_model.addConstr(0.2*X + 0.32*Y<=0.25,"first constraint")
basic_model.addConstr(X + Y ==1,"second constraint")

# write the linear programming equation
basic_model.write('week_2_practice_questions.lp')

# optimise the solution
basic_model.optimize()

# write the solution to .sol file
basic_model.write("week_2_practice_questions.sol")
