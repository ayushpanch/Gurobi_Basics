...
def main():
    ...
    # cost_of_waste_to_be_provided = st.sidebar.number_input("cost_of_waste_to_be_provided", value=1)
    # min_price_of_avacodes = st.sidebar.number_input("min_price_of_avacodes", value=0)
    # max_prce_of_avacadoes = st.sidebar.number_input("max_prce_of_avacadoes", value=2)

    # Optimize button
    # if st.sidebar.button("Optimize"):
    opt_revenue = udf_optimisation(2022,
                                    50,
                                    1,
                                    1,
                                    2)
        ...
        # st.write(f"Objective function is : {opt_revenue}")
